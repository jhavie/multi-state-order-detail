import { ACTION_CONFIG, VIEW_CONFIG } from './const';

const GOODS_ACTION_CONFIG: object[] = [
...
const GOODS_VIEW_CONFIG = (params, { goApprovalDetail, orderAmt, contractPayList }) => {
    return [
        ...
        VIEW_CONFIG.get('goodsInvoiceReqName')(params),
        VIEW_CONFIG.get('invoiceType')(params),
        VIEW_CONFIG.get('invoiceRate')(params),
        VIEW_CONFIG.get('invoiceMemo')(params),
    ];
};
export {
    GOODS_ACTION_CONFIG,
